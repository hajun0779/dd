...
Node.js(discord.js v14)로 만든 디스코드 문의 봇입니다.
...
기록에 메시지 본문을 담기 위해 필요합니다. 꺼져 있으면 기록이 빈 내용으로 저장됩니다.
...
| 채널 관리 | 문의 채널 생성 및 삭제 |
| 메시지 관리 | 문의 안내 메시지 고정 |
| 모두에게 멘션 | 스태프 역할 호출 (역할이 멘션 허용으로 되어 있으면 없어도 됩니다) |

## 슬래시 명령

| 명령 | 설명 | 권한 |
| --- | --- | --- |
| `/티켓패널` | 문의 패널을 다시 게시합니다. | 서버 관리 |
